...
namespace CarRegistrationAPI
{
    public class Startup
    {
        ...
        {
            services.AddScoped<IDeveloperRepositoryAPI, DeveloperRepositoryAPI>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CarRegistrationAPI", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CarRegistrationAPI v1"));
            }
